...
1.  Add a new line following line 9 and before **resource "azurerm_resource_group" "dev" {**, enter the following text starting in the new line, click **Commit**, and, on the **Commit** pane, click **Commit** again.
